  ...
  return (
    <nav className="nav-sidebar">
      ...
      >
        <div className="menu-item-icon">
          <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M8 1.5L9.2 4.8L12.5 6L9.2 7.2L8 10.5L6.8 7.2L3.5 6L6.8 4.8L8 1.5Z" stroke="#1E1E24" strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round"/>
            <path d="M4 10L4.6 11.4L6 12L4.6 12.6L4 14L3.4 12.6L2 12L3.4 11.4L4 10Z" stroke="#1E1E24" strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round"/>
            <path d="M12 10L12.6 11.4L14 12L12.6 12.6L12 14L11.4 12.6L10 12L11.4 11.4L12 10Z" stroke="#1E1E24" strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
        </div>
      ...
      <div className="dropdown-container">
        ...
        >
          <div className="menu-item-icon">
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M9.5 2.5H4.5C4.22 2.5 4 2.72 4 3V13C4 13.28 4.22 13.5 4.5 13.5H11.5C11.78 13.5 12 13.28 12 13V5.5L9.5 2.5Z" stroke="#1E1E24" strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round"/>
              <path d="M9.5 2.5V5.5H12" stroke="#1E1E24" strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round"/>
              <path d="M8.5 5.5H5.5C5.22 5.5 5 5.72 5 6V10C5 10.28 5.22 10.5 5.5 10.5H7.5" stroke="#1E1E24" strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
          </div>
