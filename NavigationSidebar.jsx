  ...
  return (
    <nav className="nav-sidebar">
      ...
      <div className="section-header">
        <div className="section-header-text">AI Features</div>
      </div>

      {/* Chat */}
      <div
        className={`menu-item ${selectedItem === 'chat' ? 'active' : ''}`}
        onClick={() => handleMainItemClick('chat')}
      >
        <div className="menu-item-icon">
          <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            <mask id="mask-chat-react" style={{maskType: 'alpha'}} maskUnits="userSpaceOnUse" x="0" y="0" width="16" height="16">
              <path d="M14.4288 6.82808L10.5738 5.4262L9.17189 1.5712C9.08445 1.33062 8.92508 1.12278 8.71543 0.975903C8.50577 0.82903 8.25599 0.750244 8.00001 0.750244C7.74403 0.750244 7.49425 0.82903 7.2846 0.975903C7.07495 1.12278 6.91558 1.33062 6.82814 1.5712L5.42626 5.4262L1.57126 6.82808C1.33068 6.91552 1.12284 7.07488 0.975964 7.28454C0.829091 7.49419 0.750305 7.74397 0.750305 7.99995C0.750305 8.25593 0.829091 8.50571 0.975964 8.71536C1.12284 8.92502 1.33068 9.08439 1.57126 9.17183L5.42626 10.5737L6.82814 14.4287C6.91558 14.6693 7.07495 14.8771 7.2846 15.024C7.49425 15.1709 7.74403 15.2497 8.00001 15.2497C8.25599 15.2497 8.50577 15.1709 8.71543 15.024C8.92508 14.8771 9.08445 14.6693 9.17189 14.4287L10.5738 10.5737L14.4288 9.17183C14.6693 9.08439 14.8772 8.92502 15.0241 8.71536C15.1709 8.50571 15.2497 8.25593 15.2497 7.99995C15.2497 7.74397 15.1709 7.49419 15.0241 7.28454C14.8772 7.07488 14.6693 6.91552 14.4288 6.82808ZM9.73251 9.2837C9.62946 9.32115 9.53587 9.38074 9.45833 9.45827C9.3808 9.53581 9.32121 9.6294 9.28376 9.73245L8.00001 13.2631L6.71626 9.73245C6.67881 9.6294 6.61922 9.53581 6.54169 9.45827C6.46416 9.38074 6.37057 9.32115 6.26751 9.2837L2.73689 7.99995L6.26751 6.7162C6.37057 6.67875 6.46416 6.61916 6.54169 6.54163C6.61922 6.4641 6.67881 6.37051 6.71626 6.26745L8.00001 2.73683L9.28376 6.26745C9.32121 6.37051 9.3808 6.4641 9.45833 6.54163C9.53587 6.61916 9.62946 6.67875 9.73251 6.7162L13.2631 7.99995L9.73251 9.2837Z" fill="#2F2F37"/>
            </mask>
            <g mask="url(#mask-chat-react)">
              <rect width="16" height="16" fill="#1E1E24"/>
            </g>
          </svg>
        </div>
        <div className="menu-item-text">Chat</div>
      </div>

      {/* Smart Reports Dropdown */}
      <div className="dropdown-container">
        <div
          className={`menu-item expandable ${expandedMenu === 'smart-reports' ? 'expanded' : ''} ${selectedItem === 'smart-reports' ? 'active' : ''}`}
          onClick={() => handleMenuClick('smart-reports')}
        >
          <div className="menu-item-icon">
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
              <mask id="mask-reports-react" style={{maskType: 'alpha'}} maskUnits="userSpaceOnUse" x="0" y="0" width="16" height="16">
                <path d="M13.7806 3.71938L11.2806 1.21938C11.2109 1.14975 11.1282 1.09454 11.0371 1.0569C10.9461 1.01926 10.8485 0.999923 10.75 1H5.75C5.41848 1 5.10054 1.1317 4.86612 1.36612C4.6317 1.60054 4.5 1.91848 4.5 2.25V3.5H3.5C3.16848 3.5 2.85054 3.6317 2.61612 3.86612C2.3817 4.10054 2.25 4.41848 2.25 4.75V13.5C2.25 13.8315 2.3817 14.1495 2.61612 14.3839C2.85054 14.6183 3.16848 14.75 3.5 14.75H10.25C10.5815 14.75 10.8995 14.6183 11.1339 14.3839C11.3683 14.1495 11.5 13.8315 11.5 13.5V12.25H12.75C13.0815 12.25 13.3995 12.1183 13.6339 11.8839C13.8683 11.6495 14 11.3315 14 11V4.25C14.0001 4.15148 13.9807 4.05391 13.9431 3.96286C13.9055 3.87182 13.8503 3.78908 13.7806 3.71938ZM10 13.25H3.75V5H7.9375L10 7.0625V13.25ZM12.5 10.75H11.5V6.75C11.5001 6.65148 11.4807 6.55391 11.4431 6.46286C11.4055 6.37182 11.3503 6.28908 11.2806 6.21938L8.78063 3.71938C8.71092 3.64975 8.62818 3.59454 8.53714 3.5569C8.44609 3.51926 8.34852 3.49992 8.25 3.5H6V2.5H10.4375L12.5 4.5625V10.75ZM9 9C9 9.19891 8.92098 9.38968 8.78033 9.53033C8.63968 9.67098 8.44891 9.75 8.25 9.75H5.5C5.30109 9.75 5.11032 9.67098 4.96967 9.53033C4.82902 9.38968 4.75 9.19891 4.75 9C4.75 8.80109 4.82902 8.61032 4.96967 8.46967C5.11032 8.32902 5.30109 8.25 5.5 8.25H8.25C8.44891 8.25 8.63968 8.32902 8.78033 8.46967C8.92098 8.61032 9 8.80109 9 9ZM9 11.5C9 11.6989 8.92098 11.8897 8.78033 12.0303C8.63968 12.171 8.44891 12.25 8.25 12.25H5.5C5.30109 12.25 5.11032 12.171 4.96967 12.0303C4.82902 11.8897 4.75 11.6989 4.75 11.5C4.75 11.3011 4.82902 11.1103 4.96967 10.9697C5.11032 10.829 5.30109 10.75 5.5 10.75H8.25C8.44891 10.75 8.63968 10.829 8.78033 10.9697C8.92098 11.1103 9 11.3011 9 11.5Z" fill="#1A1A1A"/>
              </mask>
              <g mask="url(#mask-reports-react)">
                <rect width="16" height="16" fill="#1E1E24"/>
              </g>
            </svg>
          </div>
          <div className="menu-item-text">Smart Reports</div>
          <div className="menu-item-arrow">
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M4 6L8 10L12 6" stroke="#1E1E24" strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
      ...
      {/* Classic Factiva Links Section */}
      <div className="section-header">
        <div className="section-header-text">Classic Factiva Links</div>
      </div>
